...
-- CreateEnum
CREATE TYPE "Emoji" AS ENUM ('LAUGH', 'HEART', 'FIRE', 'SALUTE', 'SKULL', 'FACEPALM', 'THUMBS_UP');
...
-- CreateIndex
CREATE UNIQUE INDEX "Reaction_confessionId_emoji_userId_key" ON "Reaction"("confessionId", "emoji", "userId");
